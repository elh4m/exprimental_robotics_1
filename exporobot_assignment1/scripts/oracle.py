...
# Based on the type of recieved request it loads the hint in the ARMOR reasonser, start the reasoner to deduced a hypotheses 
# based on previously loaded hints and request ARMOR reasoner for the list of 'COMPLETE' hypotheses.
